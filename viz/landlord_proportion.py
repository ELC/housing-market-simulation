...
def plot_landlord_proportion(
    data: DataFrame[GoldLandlordProportion],
    ...
    with chart(figsize) as (fig, ax):
        ...
        ax.set_title("Landlord Proportion Over Time (95% CI)")
        ax.set_xlabel("Time")
        ax.set_ylabel("Landlords / (Renters + Landlords)")
